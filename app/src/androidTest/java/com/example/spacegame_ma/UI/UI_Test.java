...
public class UI_Test {
    ...
    public void UI_Test() {
        ViewInteraction textView = onView(
                allOf(withId(R.id.title), withText("Name of the Game"),
                        childAtPosition(
                                childAtPosition(
        ...
        ViewInteraction textView2 = onView(
                allOf(withId(R.id.highscore), withText("HIGHSCORE: 0"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatButton = onView(
                allOf(withId(R.id.resetButton), withText("Reset Score"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction textView3 = onView(
                allOf(withId(R.id.highscore), withText("HIGHSCORE: 0"),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        textView3.check(matches(withText("HIGHSCORE: 0")));
